...
class VKZWindowManager extends WindowListener {
  final WidgetRef ref;
...
class VKZApp extends HookConsumerWidget {
  static final AppLogger logger = getLogger("VKZApp");
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    useEffect(
      () {
        ...
        final manager = VKZWindowManager(ref: ref);
        if (isWindows) {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SelectableText(
                    "Unfortunately, VK Я couldn't start up properly due to unhandled exception:\n$error\n\nPlease try to check for app updates, and/or create a Github Issue on VK Я Github.",
