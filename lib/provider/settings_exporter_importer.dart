...
class ExportedAudiosInfoMetadata {
  ...
  ///
  /// Если версия отличается от текущей, то это значит, что файл был создан в другой версии VK Z.
  final int exporterVersion;

  /// Версия VK Z, в которой был создан файл.
...
class SettingsExporter {
  ...
  static const exportedFilename = "Audios export.vkz";
