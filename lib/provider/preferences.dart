...
class UserPreferences {
  ...
  /// Указывает, что поле "VK Mix" включено на экране с музыкой.
  @JsonKey(name: "VKMixChipEnabled", defaultValue: true)
  final bool vkMixChipEnabled;
  ...
  UserPreferences copyWith({
    ...
    bool? statusBroadcastEnabled,
      ...
      UserPreferences(
        ...
        vkMixChipEnabled: vkMixChipEnabled ?? this.vkMixChipEnabled,
...
class Preferences extends _$Preferences {
  ...
  void setVkMixChipEnabled(bool enabled) =>
      state = state.copyWith(vkMixChipEnabled: enabled);
