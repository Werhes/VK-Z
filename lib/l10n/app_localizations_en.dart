...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get prerelease_app_version_warning_desc =>
      'Shhhh! Here be dragons! You\'ve stepped into dangerous territory by installing the beta version of VK Z. Beta versions are less stable and not recommended for regular users.\n\nBy continuing, you acknowledge the risks of using the beta version of the app.\nThis notification will only be shown once.';
  ...
  String get welcome_desc =>
      '<bold>VK Z</bold> is an experimental unofficial VK client built using the Flutter framework with <link>open source code</link> for listening to music without needing Vk Music subscription.';
  ...
  String enable_download_desc(
    ...
    return 'By enabling this feature, VK Z will automatically download all tracks in this playlist, making them available for offline listening. If you continue, VK Z will download $_temp0, that\'ll take ~$downloadSize of internet traffic.';
  }
  ...
  String logout_desc({required String name}) {
    return 'Are you sure you want to log out of the $name account in the VK Z app?';
  }
  ...
  @override
  String get export_settings_modified_settings => 'VK Z settings';
  ...
  String settings_import_version_missmatch_desc({required String version}) {
    return 'This file was created in a previous version of VK Z (v$version), which may cause issues with the import.\n\nAre you sure you want to continue?';
  }
  ...
  @override
  String get about_flutter_vk => 'About VK Z';
  ...
  String get app_github_desc =>
      'Click here to visit the Github repository of VK Z';
  ...
  @override
  String get update_available => 'VK Z update available';
  ...
  String app_update_download_long_title({required String version}) {
    return 'VK Z update v$version';
  }

  @override
  String update_available_popup({required Object version}) {
    return 'VK Z update $version available.';
  }
