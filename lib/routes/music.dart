...
import "music/categories/vk_mix.dart";
      ...
      if (hasRecommendations)
        FilterChip(
          onSelected: (bool value) {
            ...
            prefsNotifier.setVkMixChipEnabled(value);
          },
          selected: preferences.vkMixChipEnabled,
          label: Text(
            l18n.vk_mix_chip,
          ),
        ),
...
class MusicRoute extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final bool vkMix =
        hasRecommendations && preferences.vkMixChipEnabled;
