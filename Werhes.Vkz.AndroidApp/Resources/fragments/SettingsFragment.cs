...
namespace Werhes.Vkz.AndroidApp.Resources.fragments
{
    public class SettingsFragment : Fragment, View.IOnClickListener, Android.Widget.CompoundButton.IOnCheckedChangeListener
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var werhes = view.FindViewById<Button>(Resource.Id.werhes_button);
            ...
            var prefs = Application.Context.GetSharedPreferences("Vkz", FileCreationMode.Private);
            ...
            werhes.Click += (sender, e) =>
            {
                var intent = new Intent(Intent.ActionView, Android.Net.Uri.Parse("https://t.me/pulsesyncdev")) ;
                StartActivity(intent);
            };
            var dumbcat = view.FindViewById<Button>(Resource.Id.dumbcat_button);
            dumbcat.Click += (sender, e) =>
            {
                var intent = new Intent(Intent.ActionView, Android.Net.Uri.Parse("https://t.me/pusesyncdev"));
                StartActivity(intent);
            };
            Task.Run(() =>
                {
        ...
        {
            var prefs = Application.Context.GetSharedPreferences("Vkz", FileCreationMode.Private).Edit();
