...
namespace Werhes.Vkz.AndroidApp.Activities
{
    [Activity(Label = "VK Z")]
    public class MainPlayerActivity: Activity, SeekBar.IOnSeekBarChangeListener
    {
        ...
        /// <summary>
        /// РћР±РЅРѕРІР»РµРЅРёРµ РІСЃРµС… РїРѕР»РµР№ РЅР° Р»Р°СЏСѓС‚Рµ РїР»РµРµСЂР°
        /// </summary>
        ...
        /// <summary>
        /// Р’РѕР·РЅРёРєР»Р° РѕС€РёР±РєР° РїСЂРё РІРѕСЃРїСЂРѕРёР·РІРµРґРµРЅРёРё С‚СЂРµРєР°
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="args"></param>
        private void MainServiceOnItemFailed(object sender, Exception args)
        {
            //TODO: РІРѕР·РЅРёРєР»Р° РѕС€РёР±РєР° РїСЂРё РІРѕСЃРїСЂРѕРёР·РІРµРґРµРЅРёРё
            //throw new NotImplementedException();
        }

        /// <summary>
        /// РР·РјРµРЅРµРЅРёРµ С‚РµРєСѓС‰РµРіРѕ С‚СЂРµРєР°
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="args"></param>
        ...
        /// <summary>
        /// РћР±РЅРѕРІР»РµРЅРёРµ РїРѕР·РёС†РёРё 
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="args"></param>
        ...
        {
            //TODO: СЃРґРµР»Р°С‚СЊ РёРјРµРЅРµРЅРёРµ РёРєРѕРЅРѕС‡РєРё
            if (player.MainService.IsPlay)
            {
